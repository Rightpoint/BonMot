 ...
 */
CG_INLINE BONTag *BONCNonnull BONTagComplexMake(NSString *BONCNonnull startTag, NSString *BONCNonnull endTag, NSString *BONCNonnull escapeString, id<BONTextable> BONCNonnull textable)
{
    return [[BONTag alloc] initWithStartTag:startTag endTag:endTag escapeString:escapeString textable:textable];
}

/**
 *  Create a tag using the default start and end formats and using \ as an escape character. <tag> </tag>
 *
 ...
 *  @return A @p BONTag instance representing the tag.
 */
CG_INLINE BONTag *BONCNonnull BONTagMake(NSString *BONCNonnull tag, id<BONTextable> BONCNonnull textable)
{
 ...
 *
 *  @param dictionary A dictionary of textables mapped to tags.
 *
 *  @return An array of @p BONTag objects representing the tags in the dictionary.
 */
CG_INLINE BONGeneric(NSArray, BONTag *) * BONCNonnull BONTagsFromDictionary(BONGeneric(NSDictionary, NSString *, id<BONTextable>) * BONCNonnull dictionary)
{
