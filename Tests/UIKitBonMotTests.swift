...
class UIKitBonMotTests: XCTestCase {
    ...
    func testLabelExtensions() {
        ...
        XCTAssertEqual((label.attributedText?.attributes(at: 0, effectiveRange: nil)[NSAttributedStringKey.font] as? UIFont)!, expectedFont)
        BONAssertColor(inAttributes: label.attributedText?.attributes(at: 0, effectiveRange: nil), key: NSAttributedStringKey.foregroundColor, color: adaptiveStyle.color!)
    ...
    func testTextFieldExtensions() {
        ...
        XCTAssertEqual((textField.attributedText?.attributes(at: 0, effectiveRange: nil)[NSAttributedStringKey.font] as? UIFont)!, expectedFont)
        BONAssertColor(inAttributes: textField.attributedText?.attributes(at: 0, effectiveRange: nil), key: NSAttributedStringKey.foregroundColor, color: adaptiveStyle.color!)
    ...
    func testTextView() {
        ...
        XCTAssertEqual(textView.attributedText?.attributes(at: 0, effectiveRange: nil)[NSAttributedStringKey.font] as? UIFont, expectedFont)
        BONAssertColor(inAttributes: textView.attributedText?.attributes(at: 0, effectiveRange: nil), key: NSAttributedStringKey.foregroundColor, color: adaptiveStyle.color!)
    ...
    func testButton() {
        ...
        XCTAssertEqual((attributes?[NSAttributedStringKey.font] as? UIFont)!, expectedFont)
        BONAssertColor(inAttributes: attributes, key: NSAttributedStringKey.foregroundColor, color: adaptiveStyle.color!)
