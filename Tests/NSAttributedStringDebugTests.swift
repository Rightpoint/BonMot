...
class NSAttributedStringDebugTests: XCTestCase {
    ...
    func testParagraphStyleBehavior() {
        ...
        let string1 = NSMutableAttributedString(string: "first part ", attributes: [NSAttributedStringKey.paragraphStyle: style1])
        let string2 = NSAttributedString(string: "second part.\n", attributes: [NSAttributedStringKey.paragraphStyle: style2])
        string1.append(string2)
        let p1 = string1.attribute(NSAttributedStringKey.paragraphStyle, at: 0, effectiveRange: nil) as? NSParagraphStyle
        let p2 = string1.attribute(NSAttributedStringKey.paragraphStyle, at: string1.length - 1, effectiveRange: nil) as? NSParagraphStyle
