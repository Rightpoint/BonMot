...
extension Tab {
    ...
    func update(string attributedString: NSMutableAttributedString, in range: NSRange) {
        ...
        while paragraphCursor >= leadingNewline && paragraphAttribute == nil {
            ...
            paragraphAttribute = attributes[NSAttributedStringKey.paragraphStyle]
        ...
        attributedString.addAttribute(NSAttributedStringKey.paragraphStyle, value: paragraph, range: paragraphRange)
    }
